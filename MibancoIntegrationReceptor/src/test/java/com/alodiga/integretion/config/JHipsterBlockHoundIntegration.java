...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.alodiga.integretion.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.alodiga.integretion.security.DomainUserDetailsService", "createSpringSecurityUser");

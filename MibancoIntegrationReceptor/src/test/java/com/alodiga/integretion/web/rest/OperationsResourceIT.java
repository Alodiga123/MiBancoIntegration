...
class OperationsResourceIT {
    ...
    void createOperations() throws Exception {
        ...
        webTestClient
            ...
            .bodyValue(TestUtil.convertObjectToJsonBytes(operations))
            .exchange()
            .expectStatus()
            .isCreated();
    ...
    void putExistingOperations() throws Exception {
        ...
        webTestClient
            .put()
            .uri(ENTITY_API_URL_ID, updatedOperations.getId())
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(TestUtil.convertObjectToJsonBytes(updatedOperations))
            .exchange()
            .expectStatus()
            .isOk();

...
describe('Operations e2e test', () => {
  ...
  describe('Operations page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Operations page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Operations');
  ...
  describe('new Operations page', () => {
    ...
    it('should create an instance of Operations', () => {
      ...
      cy.get(`[data-cy="telefonoBeneficiario"]`).type('Plástico Masco').should('have.value', 'Plástico Masco');

      cy.get(`[data-cy="monto"]`).type('streamline digital D').should('have.value', 'streamline digital D');

      cy.get(`[data-cy="bancoEmisor"]`).type('Gené').should('have.value', 'Gené');

      cy.get(`[data-cy="concepto"]`).type('Práctico').should('have.value', 'Práctico');

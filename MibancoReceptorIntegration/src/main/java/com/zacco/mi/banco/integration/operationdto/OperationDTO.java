 ...
 */
package com.zacco.mi.banco.integration.operationdto;
...
public class OperationDTO {
    ...
    public String toString() {
        return "OperationDTO{" + "cedulaBeneficiario=" + cedulaBeneficiario + ", telefonoEmisor=" + telefonoEmisor + ", telefonoBeneficiario=" + telefonoBeneficiario + ", monto=" + monto + ", bancoEmisor=" + bancoEmisor + ", concepto=" + concepto + ", referencia=" + referencia + ", fechaHora=" + fechaHora + '}';
    }    
}

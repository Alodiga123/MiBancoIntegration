...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.alodiga.promotion.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.alodiga.promotion.security.DomainUserDetailsService", "createSpringSecurityUser");
